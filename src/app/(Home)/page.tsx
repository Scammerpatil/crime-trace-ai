      ...
      <div className="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
        <div className="mr-auto place-self-center lg:col-span-7">
          ...
          <p className="max-w-2xl mb-6 font-light text-base-content/70 lg:mb-8 md:text-lg lg:text-xl">
            Track criminal cases, analyze suspects, and identify faces with
            AI-driven investigation software using facial recognition, case
            management, and crime prediction.
          </p>
          <a
            href="/login"
